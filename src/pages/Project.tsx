...
const Project = () => {
  ...
  const jsonLd = {
    ...
    "@type": "ImageGallery",
    "name": "Synthetic Production Series",
    "description": "A collection of AI-generated product imagery showcasing controlled environments and precise visual production. These synthetic images explore the possibilities of commercial photography without physical constraints.",
    "creator": {
      "@type": "Organization",
      "name": "SIGNAL",
    ...
    "image": projectImages.map((img) => ({
      "@type": "ImageObject",
      "contentUrl": `https://signal.com${img.src}`,
      "caption": img.caption,
      "creator": {
        "@type": "Organization",
        "name": "SIGNAL"
  ...
  return (
    <>
      <SEO
        title="Synthetic Production Series - SIGNAL"
        description="A collection of AI-generated product imagery showcasing controlled environments and precise visual production. These synthetic images explore the possibilities of commercial photography without physical constraints."
      ...
      <main>
        <header className="px-8 py-20 max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-light tracking-tight mb-6">
            Synthetic Production Series
          </h1>
          <p className="text-lg leading-relaxed text-muted-foreground">
            A collection of AI-generated product imagery showcasing controlled environments and precise visual production. 
            These synthetic images explore the possibilities of commercial photography without physical constraints.
          </p>
        </header>
